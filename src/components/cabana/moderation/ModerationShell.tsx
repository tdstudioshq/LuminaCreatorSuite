...
import { ArrowLeft, ClipboardList, ScrollText, Sparkles } from "lucide-react";

/**
 * Shared luxury layout for the admin moderation subroutes (`/admin/reports`,
 * `/admin/audit`). Header + back-to-console link + tab nav between the two.
 */
    ...
    <div className="relative min-h-screen overflow-x-hidden px-4 pb-24 pt-10 sm:px-6 lg:px-10">
      ...
      <div className="mx-auto max-w-[1100px] space-y-8">
        ...
        <nav className="flex gap-2">
          <ShellTab to="/admin/reports" active={active === "reports"} Icon={ClipboardList}>
            Reports
          </ShellTab>
          <ShellTab to="/admin/audit" active={active === "audit"} Icon={ScrollText}>
            Audit log
          </ShellTab>
        </nav>
