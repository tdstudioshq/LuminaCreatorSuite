...
| `src/integrations/supabase/auth-attacher.ts`   | Client middleware intended to attach the Supabase token to server-function calls. It is not registered in `src/start.ts`.                                                                                                  |
